The folder contains scripts to model tabular data using the Titanic survival database. The database can be collected from here: [Kaggle](https://www.kaggle.com/c/titanic)
